...
If you believe you've found a vulnerability, please use [GitHub private vulnerability reporting](https://github.com/Prometheus-X-association/catalog-api/security/advisories/new) for coordinated disclosure.
